...
export const IconInfoStroke: React.FC<IconProps> = ({
  ...
  return (
    <svg
      ...
      className={className}
    >
      {/* <path d="M24 44C35.0457 44 44 35.0457 44 24C44 12.9543 35.0457 4 24 4C12.9543 4 4 12.9543 4 24C4 35.0457 12.9543 44 24 44Z" fill="none" stroke={stroke} stroke-width={strokeWidth} strokeLinejoin="round" />
            <path d="M29.6567 18.3432L18.343 29.6569" stroke={stroke} stroke-width={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
            <path d="M18.3433 18.3432L29.657 29.6569" stroke={stroke} stroke-width={strokeWidth} strokeLinecap="round" strokeLinejoin="round" /> */}
      <path
...
export const IconClose: React.FC<IconProps> = ({
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M14 14L34 34" stroke={stroke} stroke-width={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      <path d="M14 34L34 14" stroke={stroke} stroke-width={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
