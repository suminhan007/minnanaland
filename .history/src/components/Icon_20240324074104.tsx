...
export const IconUpload: React.FC<IconProps> = ({
    ...
    return (<svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g mask="url(#icon-b1dd6dd7f10b972)">
            ...
            <path d="M33 15L24 6L15 15" stroke="#202020" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /><path d="M23.9917 32V6" stroke="#202020" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></g></svg>)
}
