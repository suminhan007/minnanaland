      ...
      <div
        ...
        style={{
          background: useDivider
            ? `linear-gradient(to right,transparent calc(100% - 2px), var(--color-gray-12)  calc(100% - 2px),var(--color-gray-12) 100%) 0 0 / 100% 100%,
          linear-gradient(to right,transparent calc(100% - 2px), var(--od-gray-08)  calc(100% - 2px),
          var(--od-gray-08) 100%) 0 0 / ${step}% 100%,var(--color-gray-12) 0 0 / 100% 100%`
            : "var(--color-gray-12)",
        }}
      >
        {/* hover提示气泡:显示百分比或数值 */}
          ...
          style={{
            background:
              currentValue < 50 / step
                ? `linear-gradient(to right,var(--od-brand) calc(100% - 2px), var(--od-brand)  calc(100% - 2px)) 0 0 / ${
                    currentValue * step + 1
                  }% 100% no-repeat`
                : `linear-gradient(to right,var(--od-brand) calc(100% - 2px), var(--od-brand)  calc(100% - 2px)) 0 0 / ${
                    currentValue * step - 1
