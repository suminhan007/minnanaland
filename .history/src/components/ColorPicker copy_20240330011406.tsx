...
const ColorPicker: React.FC<ColorProps> = ({
  ...
  const handleHexInputChange = (val: string) => {
    ...
    setCurrentColor(`rgba(${rgb.r},${rgb.g},${rgb.b},${opacity})`);
    ...
    >
      <div className="land-color-trigger">
        <div
          ...
          style={{ background: getRgbaColor(currentColor, opacity / 100) }}
        ></div>
        <Input
          prefix="#"
          maxLength={6}
          ...
          <Flex gap={8}>
            <div
              ...
              style={{
                ...
                aspectRatio: 1,
                flexShrink: 0,
                background: getRgbaColor(currentColor, opacity / 100),
              }}
            ></div>
            <Flex column gap={8}>
              <StyledColorSlider
                ...
                <StyledOpacityWrap>
                  <StyledColorSlider
                    ...
                    onChange={(e: any) => {
                      ...
                      onChange?.(
                        getRgbaColor(currentColor, e.target.value / 100)
                      );
                    }}
                  />
                </StyledOpacityWrap>
          ...
          <div className="flex gap-8">
            ...
            <Input
              ...
              onChange={(val) => {
                ...
                onChange?.(getRgbaColor(currentColor, Number(val) / 100));
              }}
            />
          </div>
