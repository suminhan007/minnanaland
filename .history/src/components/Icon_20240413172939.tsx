...
export const IconToggle: React.FC<IconProps> = ({
  ...
  return (
    ...
    style={style}
    className={className}>
      <path d="M6 9L42 9" stroke={stroke} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M6 19L42 19" stroke={stroke} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
      <path d="M6 26L24 40L42 26" stroke={stroke} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
    </svg>
