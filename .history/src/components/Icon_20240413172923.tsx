...
export const IconToggle: React.FC<IconProps> = ({
  ...
  return (
    ...
    className={className}>
      ...
      <path d="M6 19L42 19" stroke="#333" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M6 26L24 40L42 26" stroke="#333" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></svg>
