      ...
      <StyleColorContainer className={`relative ${STYLE_CONTENT_ID}`}>
          ...
          {(input || opacity || stroke) && (
            <div className="flex items-center mt-16 gap-8">
              {input && (
              <Button
                text={                  <div className='flex items-center justify-start gap-8 overflow-hidden' style={{ minWidth: '52px' }}>更多</div>
              }
                icon={<StyledColorIcon className='flex items-center justify-center overflow-hidden' />}
                  type='background'
