...
export const IconClear: React.FC<Props> = ({
    ...
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" className={className} style={style} onClick={onClick}>
            <path d="M14 14L34 34" stroke={stroke} strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round" />
            <path d="M14 34L34 14" stroke={stroke} strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    )
}
