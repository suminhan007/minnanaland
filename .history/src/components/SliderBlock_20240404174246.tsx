      ...
      <div
        ...
        style={{
          background: useDivider
            ? `linear-gradient(to right,transparent calc(100% - 2px), var(--color-bg-12)  calc(100% - 2px),var(--color-bg-12) 100%) 0 0 / 100% 100%,
          linear-gradient(to right,transparent calc(100% - 2px), var(--od-gray-08)  calc(100% - 2px),
          var(--od-gray-08) 100%) 0 0 / ${step}% 100%,var(--color-bg-12) 0 0 / 100% 100%`
            : "var(--color-bg-12)",
        }}
      >
        {/* hover提示气泡:显示百分比或数值 */}
