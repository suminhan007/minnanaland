...
export const IconUpload: React.FC<IconProps> = ({
    ...
    return (<svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        <mask id="icon-b1dd6dd7f10b972" maskUnits="userSpaceOnUse" x="0" y="0" width="48" height="48" style="mask-type: alpha">
            ...
            g mask="url(#icon-b1dd6dd7f10b972)"><path d="M6 24.0083V42H42V24" stroke="#202020" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /><path d="M33 15L24 6L15 15" stroke="#202020" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /><path d="M23.9917 32V6" stroke="#202020" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /></></svg>)
}
