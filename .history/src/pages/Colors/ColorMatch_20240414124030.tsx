...
const ColorMatch: React.FC<Props> = ({}) => {
  ...
  return (
    <StyleColorContainer className="flex items-center mb-24 height-100">
      <StyleLeftBox className="flex-1 flex column gap-24 pl-24 pr-32 pt-32">
        <Flex column gap={8}>
        ...
        <Flex gap={12}>
          <div className="flex-1 flex column gap-8">
            <p className="fs-14">数量</p>
            <Title title="数量" type="p" info=""/>
            <Input
              type="number"
              max={colorArr.length}
              min={0}
        ...
        <StyleTemplateBox className="width-100 p-12 border">
          <div className="flex gap-8 width-100 overflow-auto">
            <div
              className="bg-gray"
