...
const ImgColorPicker: React.FC<Props> = ({}) => {
  ...
  function isVisuallySimilar(color1: any[], color2: any[], threshold = 0.9) {
    const floatColor1 = [color1[0] / 255, color1[1] / 255, color1[2] / 255];
    const floatColor2 = [color2[0] / 255, color2[1] / 255, color2[2] / 255];
  ...
  const analyzeImageData = (imageData: any) => {
    ...
    let topRgbValues = sortedRgbCounts.slice(0, 10);
    // 输出或处理结果
    return topRgbValues;
  };
