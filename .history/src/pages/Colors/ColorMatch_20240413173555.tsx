  ...
  return (
    <StyleColorContainer className="flex mb-24 height-100">
      <div className="flex-1 flex column gap-24 px-24 mt-32">
        ...
        {/* 颜色库 */}
        <div className={`relative flex flex-wrap both-center gap-12 p-12 width-100 border radius-6 ${showMoreColor ? 'show' : ''} `}>
          ...
          {/* 收起展开按钮 */}
          <StyleToggleBtn className="absolute flex both-center px-12 py-4 border radius-12 cursor-pointer" onClick={() => setShowMoreColor(!showMoreColor)}>
