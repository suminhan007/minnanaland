    ...
    <StyleColorContainer className="flex mb-24 height-100">
      <div className="flex-1 flex column gap-24 px-24 mt-32">
        ...
        <div className="relative flex flex-wrap both-center gap-12 p-12 width-100 border radius-6">
          ...
          {/* 收起展开按钮 */}
          <StyleToggleBtn
            className="StyleToggleBtn absolute flex both-center px-12 py-4 border radius-12 cursor-pointer transition-2s"
...
const StyleColorsLib = styled.div`
  ...
  overflow: hidden;
  & + .StyleToggleBtn svg {
    transition: transform var(--transition-02) linear;
  }
  &.show {
    height: fit-content;
    & + .StyleToggleBtn svg {
