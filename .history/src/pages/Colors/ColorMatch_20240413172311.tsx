  ...
  return (
    <StyleColorContainer className="flex mb-24 height-100">
      <div className="flex-1 flex column gap-24 px-24 mt-32">
        ...
        {/* 颜色库 */}
        <div className="relative flex flex-wrap both-center gap-12 px-12 width-100 border radius-6">
          ...
          {/* 收起展开按钮 */}
          <StyleToggleBtn className="absolute flex both-center p-4 radius-12 border cursor-pointer">
            <IconArrowDouble size={28} stroke="var(--color-text-4)" />
          </StyleToggleBtn>
        </div>
      </div>
