            ...
            <div className="flex column gap-24">
              <div className="flex column gap-8" style={{ width: "116px" }}>
                ...
                <Input
                  ...
                  onBlur={() => !disabled && getImgColor(imgUrl)}
                />
              </div>
          ...
          >
            {colorArr.length === 0 && (
              <div className="absolute" style={{zIndex:1}}>
                <Button text="提取颜色" type="background" onClick={() => { getImgColor(imgUrl); setDisabled(false)}}/>
              </div>
            )}
            {colorArr.length === 0
