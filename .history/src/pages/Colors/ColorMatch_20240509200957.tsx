...
const ColorMatch: React.FC<Props> = ({}) => {
  ...
  return (
    <StyleColorContainer className="flex items-center height-100">
      <StyleLeftBox className="flex column gap-24 pt-32 pb-24 height-100 overflow-auto">
        <div className="flex-1 width-100 px-24 flex column gap-24 overflow-auto">
          {/* 输入颜色 */}
          <Flex column gap={12}>
            <Flex column gap={8}>
        ...
        <div className="px-24 pt-24 width-100 border-top">
          <Button
            text="立即生成"
            type="background"
            status="primary"
