...
const ColorMatch: React.FC<Props> = ({}) => {
  ...
  return (
    <StyleColorContainer className="flex items-center pb-24 height-100">
      <StyleLeftBox className="flex-1 flex column gap-24 pl-24 pr-32 pt-32 height-100 overflow-auto">
        <Flex column gap={8}>
