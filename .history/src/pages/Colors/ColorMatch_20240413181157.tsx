...
const ColorMatch: React.FC<Props> = ({}) => {
  ...
  return (
    <StyleColorContainer className="flex mb-24 height-100">
      <div className="flex-1 flex column gap-24 px-24 pt-32">
        <Flex column gap={8}>
      ...
      <Button text="转换" style={{ marginLeft: "-24px",marginRight: "-24px" }} />
      <div className="flex-1 px-24 height-100 pt-32 border-left"></div>
    </StyleColorContainer>
  );
};
