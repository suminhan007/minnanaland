  ...
  return (
    <div className="flex column items-start gap-32 px-24 pt-32 mb-24">
      <Flex column gap={8}>
        ...
        {/* 颜色列表 */}
        <div
          className={`relative flex items-center justify-center flex-wrap gap-12 p-24 flex-1 border radius-6`}
        ...
        >
          ...
          {colorArr.length < 8 && (
            <StyleAddColorBtn className="StyleAddColorBtn relative flex both-center cursor-pointer">
              <DropDown
                toggle={<IconAdd />}
                dropData={[{ id: "1", laebl: "按钮一" },{ id: "2", laebl: "按钮一" }]}
              />
            </StyleAddColorBtn>
          )}
        </div>
