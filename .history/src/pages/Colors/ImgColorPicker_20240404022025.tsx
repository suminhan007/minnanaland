...
const StyleColorCardBox = styled.div<{
  ...
  &.card-3 {
    ...
    .card-img {
      width: ${props => props.ratio > 1 ? '100%' : 'calc(100)'};
    }
    .color-list {
      position: absolute;
      left: ${(props) => (props.ratio > 1 ? "50%" : "unset")};
      bottom: ${(props) => (props.ratio > 1 ? "12px" : "unset")};
      right: ${(props) => (props.ratio > 1 ? "unset" : "0")};
      top: ${(props) => (props.ratio > 1 ? "unset" : "50%")};
      padding: 12px;
