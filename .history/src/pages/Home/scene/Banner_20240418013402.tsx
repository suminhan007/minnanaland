...
import { Base, Geometry, Intersection, Subtraction } from "@react-three/csg";
type Props = {};
const Banner: React.FC<Props> = ({}) => {
  const { nodes, animations,materials } = useGLTF("banner.glb");
  return (
    <Canvas
      style={{ height: "100vh" }}
      shadows
    ...
    >
      ...
      <mesh receiveShadow>
        <Geometry useGroups>
          <Base geometry={nodes.boxr.geometry} material={materials}></Base>
          <Intersection geometry={nodes.panelr.geometry}></Intersection>
        </Geometry>
      </mesh>
      {/* <Model /> */}
      <OrbitControls />
