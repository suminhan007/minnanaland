    ...
    return (
        ...
        >
            ...
            <pointLight
                ...
                quaternion={[0.5232754945755005, -0.28416627645492554, 0.7269423007965088, 0.34203392267227173]}
            ...
            <directionalLight
                ...
                quaternion={[0.42189517617225647, 0.01938297227025032, 0.9054824113845825, -0.04160023108124733]}
            ...
            <mesh receiveShadow castShadow>
                ...
                <meshStandardMaterial roughness={0.21} metalness={1} color='#70a2ff' emissive='#315cdd' opacity={1} transparent={true} />
            </mesh>
            <AnimatePanelRight />
...
const AnimatePanelRight: React.FC<AnimatePanelProps> = ({ }) => {
    const { nodes, animations } = useGLTF("banner_baked.glb");
