...
import { AccumulativeShadows, Environment, useAnimations, useGLTF } from '@react-three/drei'
type Props = {
      ...
      <group>
        ...
        <mesh
          ...
          material={materials["blue_glass"]}
              />
              <AccumulativeShadows>
              temporal frames={200} color="purple" colorBlend={0.5} opacity={1} scale={10} alphaTest={0.85}
              </AccumulativeShadows>
      </group>
      {/* <group>
