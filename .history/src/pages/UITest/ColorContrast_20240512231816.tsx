...
const ColorContrast: React.FC<Props> = ({}) => {
  ...
  return (
    <StyleColorContrastWrap className="width-100 height-100 flex">
      ...
      >
        <div class="page-wcag-content-left" style="background-color: rgb(139, 87, 42); color: rgb(85, 216, 178);"><h1>无障碍色彩对比度</h1><blockquote style="border-color: rgb(85, 216, 178);">什么是对比度 ？</blockquote><p>对比度是两种颜色之间的亮度或颜色差异。对比度的比值越低，它们之间的差异越小。</p><blockquote style="border-color: rgb(85, 216, 178);">WCAG 的 AA级 与 AAA级 标准 ？</blockquote><p>为了确保尽可能多的人可以使用您的产品，对比度需要符合WCAG 的 <b>AA级</b> 与 <b>AAA级</b> 标准。</p><p>WCAG 的 <b>AA级</b> 要求小文本与背景的对比度至少为4.5：1，大文本与背景的对比度至少为3：1。 WCAG 的 <b>AAA级</b> 要求小文本与背景的对比度至少为7：1，大文本与背景的对比度为4.5：1。</p><p>小文本指字号在19px以下的粗体文本类型，或者是字号在24px以下的常规文本类型。 大文本指字号至少是19px以上，字重为粗体的文本类型，或者字号是24px以上的常规体文本。</p></div>
      </div>
