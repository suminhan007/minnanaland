...
const VideoToTransparent: React.FC<Props> = ({
  ...
  }, [colorUrl, alphaUrl, width, height]);
  useEffect(() => {
    ...
    <Flex column className="width-100 height-100 p-24" gap={24}>
      ...
      <Flex column gap={16}>
        ...
        <Flex gap={24} className='width-100'>
          ...
          <div className='f'><canvas ref={canvasRef} style={{ width: `${width}px`, height: `${height}px`, backgroundSize: '100% 100%', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }} ></canvas></div>
        </Flex>
      </Flex>
    </Flex >
  )
