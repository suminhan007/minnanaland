...
const VideoToTransparent: React.FC<Props> = ({}) => {
  ...
  const [background, setBackground] = useState<string>("#ddd");
    ...
    <Flex column className="width-100 height-100 p-24" gap={24}>
      ...
      <Flex column gap={16}>
        ...
        <Flex gap={24} className="width-100">
          ...
          <div
            className="flex-1 flex both-center P-16 bg-gray"
            style={{ aspectRatio: `2`, minHeight: "243px" }}
          >
            <canvas
              ref={canvasRef}
