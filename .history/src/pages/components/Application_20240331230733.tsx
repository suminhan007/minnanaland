...
const Application: React.FC<Props> = ({}) => {
  return (
    <div className="ac-navbar-left-panel ac-navbar-left-panel-mobile">
      <a
        className="ac-navbar-left-panel-return-home ac-navbar-left-panel-home-external"
      ...
      >
        ...
        <svg
          ...
          aria-hidden="true"
          focusable="false"
          className="arco-icon arco-icon-arrow-right"
        >
          <path d="m27.728 11.27 12.728 12.728-12.728 12.728M5 24h34.295"></path>
        </svg>
      </a>
      <div className="ac-navbar-left-panel-list">
        <a
          className="ac-navbar-left-panel-item"
          href="https://pro.arco.design/"
        >
          <div className="ac-navbar-left-panel-item-logo">
            <span className="ac-navbar-left-panel-item-logo-common">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <span className="ac-navbar-left-panel-item-logo-active">
              <svg
                width="24"
                height="24"
                fill="none"
          ...
          <div className="ac-navbar-left-panel-item-text">
            <p className="ac-navbar-left-panel-item-text-title">Arco Pro</p>
            <span className="ac-navbar-left-panel-item-text-desc">
              中后台最佳实践
            </span>
          </div>
        </a>
        ...
        >
          ...
          <div className="ac-navbar-left-panel-item-text">
            <p className="ac-navbar-left-panel-item-text-title">DesignLab</p>
            <span className="ac-navbar-left-panel-item-text-desc">
              设计系统配置平台
            </span>
          </div>
        ...
        >
          ...
          <div className="ac-navbar-left-panel-item-text">
            <p className="ac-navbar-left-panel-item-text-title">Material Market</p>
            <span className="ac-navbar-left-panel-item-text-desc">物料平台</span>
          </div>
        </a>
        <a
          className="ac-navbar-left-panel-item"
        ...
        >
          ...
          <div className="ac-navbar-left-panel-item-text">
            <p className="ac-navbar-left-panel-item-text-title">IconBox</p>
            <span className="ac-navbar-left-panel-item-text-desc">图标平台</span>
          </div>
        </a>
        <a
          className="ac-navbar-left-panel-item"
        ...
        >
          ...
          <div className="ac-navbar-left-panel-item-text">
            <p className="ac-navbar-left-panel-item-text-title">Platte</p>
            <span className="ac-navbar-left-panel-item-text-desc">
              色彩配置工具
            </span>
          </div>
