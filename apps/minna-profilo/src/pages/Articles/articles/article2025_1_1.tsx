...
export const article2025_1_1 = <div className={'flex column'}>
    <ArticleSectionLayout>
        <ArticleTitle type={'h2'} title={'什么是深色模式？'}/>
        ...
        <ArticlePartLayout>
            <ArticleTitle type={'h3'} title={'深色模式的设计原则'}/>
            <ArticleDesc>深色模式（Dark Mode）也叫做作暗黑模式，是一种低光用户界面（low-light UI）。深色模式可降低设备屏幕发出的亮度，同时满足最低色彩对比度，具有一定用处：
                <ul>
                    <li>有助于改善视觉人体工程学，减少眼睛疲劳</li>
                    <li>方便在黑暗环境中使用屏幕</li>
        ...
        <ArticlePartLayout>
            <ArticleTitle type={'h3'} title={'1. 深色模式的兴起与技术演进'}/>
            <ArticleDesc>深色模式的概念最早可以追溯到早期的计算机界面设计。在图形用户界面（GUI）出现之前，命令行界面普遍采用浅色文字配深色背景的显示方式。随着Web技术的发展，受印刷品设计影响，白底黑字成为网页设计的主流。
                ...
                用户需求的转变推动了深色模式的普及。随着移动设备使用时间的增加，用户对夜间浏览体验的要求不断提高。系统级深色模式的支持（如macOS的Dark Mode和Windows的夜间模式），也促使网页开发者必须考虑深色模式的实现。</ArticleDesc>
        </ArticlePartLayout>
    </ArticleSectionLayout>
    </div>