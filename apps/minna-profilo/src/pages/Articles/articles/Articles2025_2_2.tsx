...
const Articles2025_2_2:React.FC = () => <ArticleLayout>
    <ArticleSectionLayout>
        ...
        <ArticlePartLayout>
            <ArticleTitle type={'h2'} title={'三. 路径实现 Morph 变形动画的关键'}/>
            <ArticleDesc>Morph 动画是从一个图形逐渐变化到另一个图形，本质是图形的点与线在移动变化，两个图形能够互相过渡必须具备以下条件：
                <ul>
                    <li>点数相同</li>
                    <li>起点与终点相同，方向相同</li>
                    <li>两点之间的路径相同（例如都为贝塞尔曲线或都为直线）</li>
                </ul>
            </ArticleDesc>
            <ArticleImage url={'./images/articles2025/articles2025-2-2.png'} imgStyle={{width:'300px'}}></ArticleImage>
