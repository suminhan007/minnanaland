            ...
            <StyleContentWrap className='StyleContentWrap flex column items-center'>
                <div className='flex gap-12' style={{ width: '480px', height: '40px' }}>
                    <LandInput
                        ...
                        suffix={<IconClear size={22} color='#999' className='pointer' onClick={() => setInputValue("")} />}
                    />
                    <LandButton text='start' type='primary' width={80} onClick={() => inputValue && handleSubmit(inputValue)} />
                </div>
